...
export RESOURCE_GROUP_NAME=#backend resource group name
export STORAGE_ACCOUNT_NAME=#backend storage account name
export CONTAINER_NAME=#backend container name
